...
import com.cskaoyan.hackernews.service.*;
...
public class NewsController {
    ...
    public String addComment(@RequestParam("newsId") int newsId,
        ...
        return "redirect:"+toutiaoConfig.getContextPath()+"/news/" + String.valueOf(newsId);
    }
    ...
    public void getImage(@RequestParam("name") String imageName,
        ...
        try {
            ...
            StreamUtils.copy(new FileInputStream(new
                    File(toutiaoConfig.getIMAGE_DIR() +"/"+ imageName)), response.getOutputStream());
        } catch (Exception e) {
